...
Simple script to find and print constraint cells.
"""
...
def find_constraint_cells(target_cell_info, dataset='adult'):
    """Find constraint cells using the existing logic."""
    ...
    # Find constraint cells using existing logic
...
def main():
    ...
    for target in targets:
        print(f"\nTarget: {target}")
        constraint_cells = find_constraint_cells(target)
